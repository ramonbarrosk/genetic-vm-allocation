...
public class CloudSimSimulation {
    ...
    private static List<Host> createHosts() {
        ...
        int[][] hostConfigs = {
            ...
            {8, 1600, 32768, 20000, 2000000},
            {4, 1300, 16384, 10000, 1000000},
            {6, 1400, 24576, 15000, 1500000},
            {2, 1900, 8192, 5000, 500000},
            {8, 1500, 32768, 20000, 2000000},
            {4, 1400, 16384, 10000, 1000000},
            {6, 1200, 24576, 15000, 1500000},
            {4, 1700, 16384, 10000, 1000000},
            {8, 1300, 32768, 20000, 2000000},
            {4, 1500, 16384, 10000, 1000000},
            {6, 1600, 24576, 15000, 1500000},
            {2, 2100, 8192, 5000, 500000},
            {8, 1700, 32768, 20000, 2000000},
            {4, 1800, 16384, 10000, 1000000},
            {6, 1500, 24576, 15000, 1500000}
        };
    ...
    private static List<Vm> createVMs() {
        ...
        int[][] vmConfigs = {
            ...
            {1500, 2, 4096, 2000, 200000},
            {1000, 1, 1024, 1000, 50000},
            {1400, 1, 3072, 1500, 150000},
            {1000, 1, 2048, 1000, 100000},
            {1700, 2, 4096, 2000, 200000},
            {1000, 1, 1024, 1000, 50000},
            {1300, 1, 2048, 1500, 150000},
            {1000, 1, 2048, 1000, 100000},
            {1500, 2, 4096, 2000, 200000},
            {1000, 1, 1024, 1000, 50000},
            {1900, 2, 4096, 2000, 200000},
            {1000, 1, 2048, 1000, 100000},
            {1200, 1, 3072, 1500, 150000},
            {1000, 1, 1024, 1000, 50000},
            {1500, 2, 4096, 2000, 200000},
    ...
    private static List<Cloudlet> createCloudlets() {
        ...
        int[] cloudletSizes = {
            ...
            22000, 62000, 105000, 38000, 72000,
            28000, 68000, 115000, 42000, 82000,
            32000, 58000, 125000, 45000, 88000,
            19000, 64000, 108000, 36000, 78000,
            26000, 66000, 112000, 41000, 86000,
            29000, 59000, 118000, 43000, 92000
        };
